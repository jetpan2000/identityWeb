...
class DocumentTabMain extends React.Component {
    constructor(props) {
        ...
        this.invoiceHeaderValidations = [{
            ...
            method: (inputValue) => {
                ...
                var lineTotals = lineItemTotalAmounts.reduce((accumulator, currentValue) => {
    ...
    render() {
        ...
        var fieldOverrides = [{
            name: 'c0a7c606-e7f3-e811-822e-d89ef34a256d|2d767887-dbca-4fa7-861f-b6b7510e3eab|fd8a1bee-5a40-471a-8e31-7dba8ea6dd32',
            lookupValueField: 'purchaseOrder',
            lookupPromiseResolver: (field, searchString) => {
                const { plantNumber } = store.document;

                return invoiceLookupSvc.searchPurchaseOrders(searchString, plantNumber).then(data => data.records);
            }
        }, {
            ...
            name: '896183ae-e40a-e911-842c-005056820bd7|5d24d8e9-c0cf-42be-8d50-668a984b1aa8|0006a605-061d-4d48-bef1-88189d758f33',
            CustomElement: ({props}) => {
                    ...
                    { store.document && <React.Fragment>
                        ...
                        <DocumentTab.Section title="Line Items">
                            <LineItems 
                                ...
                                isReadOnly={store.isReadOnly}
                                fieldOverrides={[{
                                    name: '746a3545-3cf7-e811-822e-d89ef34a256d|19375c8a-1008-450a-9056-2cbfb0029ab4|054e30c1-a645-47c9-9ee9-7921c118677a',
                                    ...
                                    name: '443cfb60-3cf7-e811-822e-d89ef34a256d|18d8e1b0-1a4a-4284-bcfb-f17d63885bc7|c4bbe481-5c7a-4d20-aca2-d1b9dbd30baa',
